    ...
    >
      ...
      <div className="px-4 py-2.5 border-b border-white/10 bg-white/[0.02] flex items-center justify-between">
        ...
        <button
          ...
          className="hidden sm:flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-emerald-600/30 border border-emerald-500/40 text-emerald-300 text-xs font-medium hover:bg-emerald-600/40 transition-all"
        >
          <Download size={13} />
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {PROFILE_DATA.stats.map(stat => (
                <div
                  key={stat.label}
                  className="bg-white/[0.03] border border-white/10 rounded-xl p-3.5 text-center shadow-md"
                >
            ...
            <div className="relative border-l-2 border-blue-500/30 ml-4 pl-6 space-y-8">
              {PROFILE_DATA.timeline.map((item, idx) => (
                <div key={idx} className="relative group">
                  {/* Timeline Dot Node */}
                  <div className="absolute -left-[31px] top-1.5 w-3.5 h-3.5 rounded-full bg-blue-500 border-2 border-stone-950 shadow-md shadow-blue-500/50 group-hover:scale-125 transition-transform" />

                  <div className="bg-white/[0.03] hover:bg-white/[0.06] border border-white/10 rounded-xl p-4 transition-all">
